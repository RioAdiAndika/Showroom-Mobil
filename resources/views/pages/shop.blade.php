...
@section('content')
    ...
    <div class="py-5 container-fluid ">
        <div class="container py-5">
            <h1 class="mb-4">Auto Garage 77</h1>
            <div class="row g-4">
                <div class="col-lg-12">
                    <div class="row g-4">
                        <div class="col-xl-3">
                        ...
                        <div class="col-xl-3">
                            <div class="py-3 mb-4 rounded bg-light ps-3 d-flex justify-content-between">
                                ...
                                <select id="fruits" name="fruitlist" class="border-0 form-select-sm bg-light me-3"
                                    ...
                                    <option value="opel">Hatchback</option>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <output id="amount" name="amount" min-velue="0" max-value="1000000000"
