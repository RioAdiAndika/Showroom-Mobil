      ...
      <div class="container py-5">
          <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
              <div class="row g-4">
                  <div class="col-lg-3">
                      <a href="#">
                          <h2 class="mb-0 text-primary">Auto Garage 77</h2>
                          <p class="mb-0 text-secondary">Best Product Ever</p>
                      </a>
                  </div>
                  <div class="col-lg-6">
          ...
          <div class="row g-5">
              ...
              <div class="col-lg-3 col-md-6">
                  <div class="footer-item">
                      ...
                      <p>Address: Rungkut, Surabaya 54321</p>
                      <p>Email: autogarage77@gmail.com</p>
          ...
          <div class="row">
              <div class="mb-3 text-center col-md-6 text-md-start mb-md-0">
                  <span class="text-light"><a href="{{ route('home') }}"><i
                              class="fas fa-copyright text-light me-2"></i>Auto Garage
                          77</a>, All right reserved 2024.</span>
              </div>
          </div>
      </div>
      <!-- Copyright End -->
